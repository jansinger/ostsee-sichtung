    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          style: {
            description: '💄 Änderungen, die die Bedeutung des Codes nicht beeinflussen (Whitespace, Formatierung, etc.)',
            title: 'Styles',
            emoji: '💄',
          },
          refactor: {
            description: '♻️ Code-Änderung, die weder einen Fehler behebt noch ein Feature hinzufügt',
      ...
      breakingBody: {
        description: 'Ein Breaking Change Commit erfordert einen Body. Bitte gib eine längere Beschreibung des Commits ein:',
      },
      breaking: {
      ...
      issuesBody: {
        description: 'Wenn Issues geschlossen werden, erfordert der Commit einen Body. Bitte gib eine längere Beschreibung des Commits ein:',
      },
      issues: {
