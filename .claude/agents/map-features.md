...
Siehe `.claude/rules/database.md` für PostGIS Patterns (ST_Point, ST_DWithin, ST_Distance).
...
Siehe `.claude/rules/maps.md` für Ostsee-Bounds, View Constraints und CSP-Konfiguration.
