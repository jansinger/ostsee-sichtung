...
[PublicFooter.svelte:42](src/lib/components/PublicFooter.svelte:42),
[about/+page.svelte:330](src/routes/about/+page.svelte:330) sowie die Einwilligungstexte im Formular.
...
| -------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| Erhebung von Sichtungsdaten (Datum, Position, Tierart, Anzahl) | [schema.ts:33–58](src/lib/server/db/schema.ts:33)                                   | Vom Absatz oben und dem Verweis auf den Erhebungsbogen getragen   |
| Veröffentlichung der Sichtungsinformationen im Internet        | [publicMapConditions.ts:31](src/routes/api/map/sightings/publicMapConditions.ts:31) | Ausdrücklich genannt („Bereitstellung … im Internet")             |
| Kontaktdaten für Rückfragen durch Wissenschaftler              | [schema.ts:63–70](src/lib/server/db/schema.ts:63)                                   | Ausdrücklich genannt („Kontaktaufnahme … bei Nachfragen")         |
| Rechtsgrundlage Einwilligung (Art. 6 Abs. 1 lit. a)            | [sightingSchema.ts:1218–1224](src/lib/form/validation/sightingSchema.ts:1218)       | Erklärung nennt Einwilligung als Grundlage für Sichtungsmeldungen |
...
([uploadRetention.ts:15](src/lib/constants/uploadRetention.ts:15)). Für Sichtungen samt Klarnamen,
...
([+page.svelte:324](src/routes/about/+page.svelte:324)):
...
- [upload/+server.ts:234–239](src/routes/api/files/upload/+server.ts:234) — `storage.upload(file, buffer, …)` neben `readImageExifData(buffer)`
- [upload/+server.ts:256](src/routes/api/files/upload/+server.ts:256) — `uploadedFile.exifData = metadata`
- [schema.ts:165](src/lib/server/db/schema.ts:165) — Spalte `exif_daten`
- [exifUtils.ts:36–46](src/lib/server/media/exifUtils.ts:36) — gelesen werden u. a. `GPSLatitude`, `GPSLongitude`, `GPSAltitude`, `Make`, `Model`
...
[uploads/[...path]:105](src/routes/uploads/[...path]/+server.ts:105) und
[api/media/[...path]:193](src/routes/api/media/[...path]/+server.ts:193)) — **aber kein
...
- `GET /api/sightings/[id]` ist die einzige Route mit `uploadedFiles` und admin-gated
  ([+server.ts:44](src/routes/api/sightings/[id]/+server.ts:44))
...
- Die Medien-UI läuft nur über
  [AdminSightingView.svelte:682](src/lib/components/admin/AdminSightingView.svelte:682)
- Der Pfad besteht aus zwei cuid2-Werten ([local.ts:137](src/lib/server/storage/local.ts:137)) —
  nicht aufzählbar
...
([schema.ts:105](src/lib/server/db/schema.ts:105)) bereits existiert. Für den Abgleich bleibt
...
([MediaModal.svelte:55–70](src/lib/components/media/MediaModal.svelte:55) greift auf `file.exifData`
...
([schema.ts:63–70](src/lib/server/db/schema.ts:63)) sowie **Schiffsname, Heimathafen, Bootstyp,
Bootsantrieb** ([schema.ts:57–62](src/lib/server/db/schema.ts:57)). Die vollständige Postanschrift
...
- OpenStreetMap-Basiskarte — [optimizedMapController.ts:254](src/lib/map/optimizedMapController.ts:254)
- OpenSeaMap-Seezeichen — [optimizedMapController.ts:211](src/lib/map/optimizedMapController.ts:211)
...
serverseitig** über einen eigenen Endpunkt ([api/weather/historical/+server.ts:73](src/routes/api/weather/historical/+server.ts:73)),
...
Weder Auth0/Okta (Admin-Login, [auth.ts:13–15](src/lib/server/auth/auth.ts:13)) noch der SMTP-Versand
der Benachrichtigungen ([emailService.ts:351](src/lib/server/services/emailService.ts:351)) tauchen
...
([+page.svelte:318](src/routes/about/+page.svelte:318)) — die verlinkte Erklärung kennt diesen
...
| ----------------------------------------------------------- | ----------------------------------------------------------- |
| IP-Adressen im Audit-Log                                    | [schema.ts:203](src/lib/server/db/schema.ts:203)            |
| Browser-Speicherung der Formulareingaben (`sessionStorage`) | [localStorage.ts:55–58](src/lib/storage/localStorage.ts:55) |
| Dauerhafte Kontaktdaten im `localStorage`                   | [localStorage.ts:336](src/lib/storage/localStorage.ts:336)  |
| Server-Sessions mit Auth0-Claims                            | [schema.ts:220](src/lib/server/db/schema.ts:220)            |

Die Browser-Speicherung ist immerhin **einwilligungsgebunden** (`persistentDataConsent`,
[localStorage.ts:336](src/lib/storage/localStorage.ts:336)) und der Entwurf liegt nur in
...
([+page.svelte:243–247](src/routes/about/+page.svelte:243)) begründet die Streichung mit derselben
...
([+page.svelte:295](src/routes/about/+page.svelte:295)).
...
`new Date()` ([mapFormToSighting.ts:313–326](src/lib/server/db/mapFormToSighting.ts:313)) — aber der
Admin-Edit schreibt diese Spalten nie: `updateSighting` destrukturiert **Flags und Nachweisspalten**
vor dem `.set()` heraus ([sightingRepository.ts:159–177](src/lib/server/db/sightingRepository.ts:159)).
...
jetzt `approvedOnly()` ([+server.ts:80–84](src/routes/api/sightings/+server.ts:80)). Die Zusage des
...
3. **Getrennte Lebenszyklen.** Die Erklärung steht auf 05.11.2024, die App ändert ihre Verarbeitung
   ...
   ([PublicFooter.svelte:27](src/lib/components/PublicFooter.svelte:27)) die _Kopie_ der Rechtstexte
