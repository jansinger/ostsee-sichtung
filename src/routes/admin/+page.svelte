...
<div class="container mx-auto p-4">
	...
	{#if isFilterPanelOpen}
		<div class="bg-base-200 mb-4 rounded-lg p-3 shadow-sm transition-all duration-300">
			...
			<div class="mt-2 flex justify-end gap-1">
				<button class="btn btn-outline btn-xs" onclick={resetFilters}>Zurücksetzen</button>
				<button class="btn btn-primary btn-xs" onclick={applyFilters}>Anwenden</button>
			</div>
		</div>
	{/if}
	...
	<div class="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
		<div class="flex items-center gap-2">
			...
			<select
				class="select-bordered select select-sm text-sm"
