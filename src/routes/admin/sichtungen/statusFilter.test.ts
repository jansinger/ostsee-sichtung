...
describe('statusCondition', () => {
	...
	/* Regression zum Bestandsbefund vom 2026-08-07: 22 Zeilen tragen
	   `geprueft = 1` ohne Freigabe, 9 eine Freigabe ohne `geprueft = 1`. Der
	   alte Filter las `geprueft` und lieferte damit beide Gruppen falsch. */
