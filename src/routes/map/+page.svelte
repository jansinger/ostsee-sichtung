<script lang="ts">
	import FilterPanel from '$lib/components/map/Panel/FilterPanel.svelte';
	import LegendPanel from '$lib/components/map/Panel/LegendPanel.svelte';
...
<svelte:head>
	<title>Sichtungskarte - Deutsches Meeresmuseum</title>
</svelte:head>

<div class="relative h-screen w-screen overflow-hidden">
	<h1
		class="bg-opacity-50 text-1xl absolute top-2 left-2 z-30 rounded bg-gray-500 px-2 py-1 font-bold text-white"
	>
		Sichtungskarte
	</h1>
	...
	<!-- Logo (unten rechts) - optimierte Größe für bessere Lesbarkeit -->
